...
describe Kitchen::Driver::Dummy do
  ...
  describe "#create" do
    ...
    it "raises ActionFailed if :fail_create is set" do
      ...
      _(proc { driver.create(state) }).must_raise Kitchen::ActionFailed
    end
  ...
  describe "#setup" do
    ...
    it "raises ActionFailed if :fail_setup is set" do
      ...
      _(proc { driver.setup(state) }).must_raise Kitchen::ActionFailed
    end
  ...
  describe "#verify" do
    ...
    it "raises ActionFailed if :fail_verify is set" do
      ...
      _(proc { driver.verify(state) }).must_raise Kitchen::ActionFailed
    end
  ...
  describe "#destroy" do
    ...
    it "raises ActionFailed if :fail_destroy is set" do
      ...
      _(proc { driver.destroy(state) }).must_raise Kitchen::ActionFailed
    end
